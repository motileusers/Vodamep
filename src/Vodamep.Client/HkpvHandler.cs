...
{
    public class HkpvHandler : HandlerBase
    {
        ...
        public override void PackRandom(PackRandomArgs args)
        {
            ...
            var r = HkpvDataGenerator.Instance.CreateHkpvReport(args.InstitutionId, year, month, args.Persons, args.Staffs, args.AddActivities);
