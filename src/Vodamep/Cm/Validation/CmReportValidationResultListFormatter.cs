...
{
    public class CmReportValidationResultListFormatter
    {
        ...
        private string GetNameOfStaffById(CmReport report, string id)
        {
        ...
        private string GetInfo(CmReport report, string propertyName)
        {
