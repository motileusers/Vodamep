...
{
    internal class MkkpReportSendClient
    {
        private readonly Uri _address;

        public MkkpReportSendClient(Uri address)
        {
            _address = address;
        }
        public async Task<SendResult> Send(MkkpReport report, string username, string password)
        {
