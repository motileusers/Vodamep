...
{
    public class TpReportValidationResultListFormatter
    {

        private readonly ResultFormatterTemplate _template;
        private readonly bool _ignoreWarnings;

        public TpReportValidationResultListFormatter(ResultFormatterTemplate template, bool ignoreWarnings = false)
        {
            _template = template;
