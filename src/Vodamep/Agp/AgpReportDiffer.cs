...
{
    internal class AgpReportDiffer : ReportDifferBase
    {

        public AgpReportDiffer()
        {
            this.DiffFunctions.Add(typeof(RepeatedField<Mkkp.Model.Person>), this.DiffPersons);
            this.DiffFunctions.Add(typeof(RepeatedField<Mkkp.Model.Staff>), this.DiffStaffs);
            this.DiffFunctions.Add(typeof(RepeatedField<Mkkp.Model.Activity>), this.DiffActivities);
        }

        private IEnumerable<DiffObject> DiffStaffs(object obj1, object obj2)
        {
            var staffs1 = (obj1 as RepeatedField<Mkkp.Model.Staff>);
        ...
        {
            var persons1 = (obj1 as RepeatedField<Mkkp.Model.Person>);
