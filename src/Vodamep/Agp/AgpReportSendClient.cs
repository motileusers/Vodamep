...
{
    internal class AgpReportSendClient
    {
        private readonly Uri _address;

        public AgpReportSendClient(Uri address)
        {
            _address = address;
        }
        public async Task<SendResult> Send(AgpReport report, string username, string password)
        {
