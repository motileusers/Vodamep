...
{
    public class MohiReportValidationResultListFormatter
    {

        private readonly ResultFormatterTemplate _template;
        private readonly bool _ignoreWarnings;

        public MohiReportValidationResultListFormatter(ResultFormatterTemplate template, bool ignoreWarnings = false)
        {
            _template = template;
        ...
        public IEnumerable<string> Format(MohiReport report, ValidationResult validationResult)
        {
        ...
        private string GetNameOfStaff(MohiReport report, int index)
        {
        ...
        private string GetNameOfStaffById(MohiReport report, string id)
        {
        ...
        private string GetInfo(MohiReport report, string propertyName)
        {
