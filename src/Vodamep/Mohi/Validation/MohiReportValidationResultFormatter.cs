...
{
    public class MohiReportValidationResultFormatter
    {

        private readonly ResultFormatterTemplate _template;
        private readonly bool _ignoreWarnings;

        public MohiReportValidationResultFormatter(ResultFormatterTemplate template, bool ignoreWarnings = false)
        {
            _template = template;
        ...
        public string Format(MohiReport report, ValidationResult validationResult)
        {
