...
Szenario: Unterschiedliche Klientenleistung
	...
	Dann enthält das Ergebnis '1' Objekte(e)
	Und das '1'. Element besitzt den Status 'Difference' mit der Id 'PersonActivity', dem Wert1 '3' und dem Wert2 '3'
...
Szenario: Unterschiedliche nicht klientenbezogene Klientenleistung
	...
	Dann enthält das Ergebnis '1' Objekte(e)
	Und das '1'. Element besitzt den Status 'Difference' mit der Id 'StaffActivity', dem Wert1 '3' und dem Wert2 '3'
...
Szenario: Fehlendes Anstellungsverhältnis Mitarbeiter
	...
	Dann enthält das Ergebnis '2' Objekte(e)
	Und das '1'. Element besitzt den Status 'Difference' mit der Id 'Employment', dem Wert1 '3' und dem Wert2 '2.5'
	Und das '2'. Element besitzt den Status 'Difference' mit der Id 'Staff', dem Wert1 '2' und dem Wert2 ''
