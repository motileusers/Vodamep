#language: de-DE
Funktionalität: Hkpv - Unterschiede zwischen zwei Meldungen
...
Szenario: Fehlender Klient.
	...
	Und ein Element besitzt den Status 'Difference' mit der Id 'PersonActivity', dem Wert1 '3' und dem Wert2 '2'
	Und ein Element besitzt den Status 'Missing' mit der Id 'Person', dem Wert1 '2' und dem Wert2 ''
...
Szenario: Fehlender Mitarbeiter
	...
	Dann enthält das Ergebnis '2' Objekte(e)
	Und ein Element besitzt den Status 'Difference' mit der Id 'StaffActivity', dem Wert1 '3' und dem Wert2 '2'
	Und ein Element besitzt den Status 'Missing' mit der Id 'Staff', dem Wert1 '2' und dem Wert2 ''

Szenario: Fehlende Klientenleistung
	Angenommen die Meldung1 enthält den Klienten '1' mit '2' Klientenleistungen
	Und die Meldung1 enthält den Klienten '2' mit '2' Klientenleistungen
	Und die Meldung1 enthält den Klienten '3' mit '2' Klientenleistungen
	Und die Meldung2 enthält den Klienten '1' mit '2' Klientenleistungen
	Und die Meldung2 enthält den Klienten '2' mit '1' Klientenleistungen
	Und die Meldung2 enthält den Klienten '3' mit '2' Klientenleistungen
	Dann enthält das Ergebnis '1' Objekte(e)
	Und ein Element besitzt den Status 'Difference' mit der Id 'PersonActivity', dem Wert1 '6' und dem Wert2 '5'

Szenario: Unterschiedliche Klientenleistung
	Angenommen die Meldung1 enthält den Klienten '1' mit '1' Klientenleistungen
	Und die Meldung1 enthält den Klienten '2' mit '1' Klientenleistungen
	Und die Meldung1 enthält den Klienten '3' mit '1' Klientenleistungen
	Und die Meldung2 enthält den Klienten '1' mit '1' Klientenleistungen
	Und die Meldung2 enthält den Klienten '2' mit '1' Klientenleistungen
	Und die Meldung2 enthält den Klienten '3' mit '1' Klientenleistungen
	Und die Eigenschaft 'entries' von 'Activity' von Report 1 ist auf '5' gesetzt
	Dann enthält das Ergebnis '1' Objekte(e)
	Und ein Element besitzt den Status 'Difference' mit der Id 'PersonActivity', dem Wert1 '3' und dem Wert2 '3'
...
Szenario: Fehlende nicht klientenbezogene Klientenleistung
	...
	Dann enthält das Ergebnis '1' Objekte(e)
	Und ein Element besitzt den Status 'Difference' mit der Id 'StaffActivity', dem Wert1 '6' und dem Wert2 '5'
...
Szenario: Unterschiedliche nicht klientenbezogene Klientenleistung
	...
	Dann enthält das Ergebnis '1' Objekte(e)
	Und ein Element besitzt den Status 'Difference' mit der Id 'StaffActivity', dem Wert1 '3' und dem Wert2 '3'

Szenario: Fehlendes Anstellungsverhältnis Mitarbeiter
	Angenommen die Meldung1 enthält den Mitarbeiter '1' mit '1' Mitarbeiterleistungen und mit '2' Anstellungen mit '20' Stunden pro Woche
	Und die Meldung1 enthält den Mitarbeiter '2' mit '1' Mitarbeiterleistungen und mit '2' Anstellungen mit '20' Stunden pro Woche
	Und die Meldung1 enthält den Mitarbeiter '3' mit '1' Mitarbeiterleistungen und mit '2' Anstellungen mit '20' Stunden pro Woche
...
Szenario: Unterschiedliches Anstellungsverhältnis Mitarbeiter
	...
	Und die Meldung1 enthält den Mitarbeiter '2' mit '1' Mitarbeiterleistungen und mit '1' Anstellungen mit '40' Stunden pro Woche
	Und die Meldung1 enthält den Mitarbeiter '3' mit '1' Mitarbeiterleistungen und mit '1' Anstellungen mit '40' Stunden pro Woche
