...
Szenario: Bis-Datum muss der letzte Tag des Monats sein.
    Angenommen die Eigenschaft 'to' von 'AgpReport' ist auf '2018-04-04' gesetzt
...
Szenario: Die Meldung muss genau einen Monat beinhalten.
    Angenommen die Eigenschaft 'from' von 'AgpReport' ist auf '2018-03-01' gesetzt
...
Szenario: Die Meldung darf nicht die Zukunft betreffen.
    Angenommen die Eigenschaft 'to' von 'AgpReport' ist auf '2058-04-30' gesetzt
    Dann enthält das Validierungsergebnis den Fehler 'Der Wert von 'Bis' muss kleiner oder gleich .*'

Szenariogrundriss: Eine Eigenschaft ist nicht gesetzt
    Angenommen die Eigenschaft '<Name>' von 'AgpReport' ist nicht gesetzt
...
Szenariogrundriss: Die Datumsfelder dürfen keine Zeit enthalten
    Angenommen die Datums-Eigenschaft '<Name>' von 'AgpReport' hat eine Uhrzeit gesetzt
