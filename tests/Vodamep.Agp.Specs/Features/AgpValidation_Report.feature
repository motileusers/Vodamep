#language: de-DE
Funktionalität: Agp - Validierung der Datenmeldung
...
Szenario: Von-Datum muss der erste Tag des Monats sein.
    Angenommen es ist ein 'AgpReport'
    Und die Eigenschaft 'from' von 'AgpReport' ist auf '2018-04-04' gesetzt
...
Szenario: Bis-Datum muss der letzte Tag des Monats sein.
    Angenommen es ist ein 'AgpReport'
    Und die Eigenschaft 'to' von 'AgpReport' ist auf '2018-04-04' gesetzt
...
Szenario: Die Meldung muss genau einen Monat beinhalten.
    Angenommen es ist ein 'AgpReport'
    Und die Eigenschaft 'from' von 'AgpReport' ist auf '2018-03-01' gesetzt
    Und die Eigenschaft 'to' von 'AgpReport' ist auf '2018-04-30' gesetzt
...
Szenario: Die Meldung darf nicht die Zukunft betreffen.
    Angenommen es ist ein 'AgpReport'
    Und die Eigenschaft 'to' von 'AgpReport' ist auf '2058-04-30' gesetzt
    Dann enthält das Validierungsergebnis den Fehler 'Der Wert von 'Bis' muss kleiner oder gleich .*'

Szenariogrundriss: Eine Eigenschaft ist nicht gesetzt
    Angenommen es ist ein 'AgpReport'
    Und die Eigenschaft '<Name>' von 'AgpReport' ist nicht gesetzt
...
Szenariogrundriss: Die Datumsfelder dürfen keine Zeit enthalten
    Angenommen es ist ein 'AgpReport'
    Und die Datums-Eigenschaft '<Name>' von 'AgpReport' hat eine Uhrzeit gesetzt
