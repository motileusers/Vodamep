...
Szenariogrundriss: Ungültige Werte bei der Leistung
	...
	Und die Eigenschaft '<Name>' von 'Activity' ist auf '<Wert>' gesetzt
	...
	Beispiele:
		...
		| hours_per_month | 1      | 0.375		| Bei der Leistung von Person '1' muss der Wert in 0.25 Schritten angegeben werden. |
...
Szenario: Mehrfache Leistungen pro Klient pro Monat
	Angenommen für einen Mohi-Klient gibt es mehrfache Leistungen
