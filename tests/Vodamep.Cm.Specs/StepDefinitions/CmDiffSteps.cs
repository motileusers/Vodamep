...
namespace Vodamep.Specs.StepDefinitions
{
    ...
    public class CmDiffSteps
    {
        ...
        public CmReport Report1 { get; private set; }

        public CmReport Report2 { get; private set; }

        [BeforeScenario()]
        public void BeforeScenario()
        {
            this.Report1 = CmDataGenerator.Instance.CreateCmReport(string.Empty, null, null, 1, 1, true);
