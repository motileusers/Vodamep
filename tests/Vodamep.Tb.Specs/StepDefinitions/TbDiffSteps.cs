...
namespace Vodamep.Specs.StepDefinitions
{
    ...
    public class TbDiffSteps
    {
        ...
        public TbReport Report1 { get; private set; }

        public TbReport Report2 { get; private set; }

        [BeforeScenario()]
        public void BeforeScenario()
        {
            this.Report1 = TbDataGenerator.Instance.CreateTbReport(string.Empty, null, null, 1, 1, true);
